...
#define Waiting_Message			"System Getting  Ready           Please Wait ..."
/* =========================================================================
 *                                  Typedefs
 * =========================================================================*/
typedef enum
...
uint8_t 	Glob_ID_Req[NAME_MAX_SIZE+1];
uint8_t 	Test_ID[10] = "24689";

uint8_t Master_Response = 'w';
uint8_t Master_RxData = 'm';
uint8_t ID_arr[10];
